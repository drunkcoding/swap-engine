...
df = pd.DataFrame(
    [
        {"model": "Cascade", "variant": "DeepSpeed", "latency": 3},
        {"model": "Cascade", "variant": "SwapAdvisor", "latency": 3},
        {"model": "Cascade", "variant": "Ours", "latency": 3},
        {"model": "MoE", "variant": "DeepSpeed", "latency": 5},
        {"model": "MoE", "variant": "SwapAdvisor", "latency": 5},
        {"model": "MoE", "variant": "Ours", "latency": 5},
    ]
)
